    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li class="active">
                                <i class="fa fa-edit"></i> Delete Data Rumah Sakit
                            </li>
                        </ol>
                    </div>
                </div>
            ...
            foreach ($rs as $rumahsakit) {
                ...
                print $rumahsakit->id;
                print "<td>";
                print $rumahsakit->nama;
                print "<td>";
                print $rumahsakit->alamat;
                print "<td>";
                print $rumahsakit->no_telp;
                print "<td>";
                print $rumahsakit->keterangan;
                print "<td>";
				echo "<a href='".site_url('Rumah_Sakit/delete/'.$rumahsakit->id)."'><button>Hapus</button></a>";
				print "<td>";
