...
<body>
    ...
    <div id="wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-bar-chart-o"></i> Tambah Data Penyakit
                            </li>
                        </ol>
                    </div>
                </div>
        ...
        <table>
            ...
            <?php
            foreach ($zz as $penyakit) {
                print "<tr>";
                print "<td>";
                print $penyakit->id_penyakit;
                print "<td>";
                print $penyakit->nama;
                print "<td>";
                print $penyakit->obat;
                print "<td>";
                print $penyakit->gejala1;
                print "<td>";
                print $penyakit->gejala2;
                print "<td>";
                print $penyakit->gejala3;
                print "<td>";
...
<table width="546" border="0" cellpadding="0" cellspacing="0" align="center" bgcolor="#FFFFFF">
  ...
  <tr>
    <td height="27" align="right" valign="middle">Obat</td>
    <td align="center" valign="top">:</td>
    <td valign="middle"><label>
      <input name="obat" type="text" size="50">
    </label></td>
  </tr>
  <tr>
    <td height="27" align="right" valign="middle">Gejala 1</td>
    <td align="center" valign="top">:</td>
    <td valign="middle"><label>
      <input name="gejala1" type="text" size="15">
    </label></td>
  </tr>
  <tr>
    <td height="27" align="right" valign="middle">Gejala 2</td>
    <td align="center" valign="top">:</td>
    <td valign="middle"><label>
    <input name="gejala2" type="text" size="15">
    </label></td>
  </tr>
  <tr>
    <td height="27" align="right" valign="middle">Gejala 3</td>
    <td align="center" valign="top">:</td>
    <td valign="middle"><label>
    <input name="gejala3" type="text" size="15">
    </label></td>
  </tr>
    <td height="42"> </td>
    <td> </td>
