...
<body>
 ...
 <div id="form_input">
 <table>
 <?php echo form_open('rumah_sakit/submit'); ?>
 ...
 <td> <?php echo form_input('alamat',$falamat,'id="alamat"'); ?></td>
 </tr>
 <tr>
 <td> <?php echo form_label('No. Telp : ');?> </td>
 <td> <?php echo form_input('no_telp',$fno_telp,'id="no_telp"'); ?></td>
 </tr>
 <tr>
 <td> <?php echo form_label('Keterangan : ');?> </td>
 <td> <?php echo form_textarea('keterangan',$fketerangan,'id="keterangan"'); ?></td>
 </tr>
 <tr>
