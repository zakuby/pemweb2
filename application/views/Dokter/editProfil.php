...
<meta name="description" content="">
    ...
    <title>DOKTER Edit Profil</title>
...
<form role="form" method="POST" enctype="multipart/form-data" class="d-profile" unselectable="on" action="<?php echo base_url();?>Dokter/update">
...
<form role="form" method="POST" enctype="multipart/form-data" class="d-profile" unselectable="on" action="<?php echo base_url();?>Dokter/update">
            <div class="form-group">
                ...
                <input class="form-control" name="nama_depan" value="<?php echo $First_Name;?>" required>
            </div>
            <div class="form-group">
            <label>Nama Belakang</label>          
                <input class="form-control" name="nama_belakang" value="<?php echo $Last_Name;?>" required>
            </div>            
            <div class="form-group">
                <label>Alamat</label>          
                <input class="form-control" name="alamat" value="<?php echo $Alamat;?>" required>
            </div>
            <div class="form-group">
                <label>Spesialis</label>          
                <input class="form-control" name="spesialis" value="<?php echo $Spesialis;?>" required>
            </div>
            <div class="form-group">
                <label>Jenis Kelamin</label>          
                <input class="form-control" name="jenis_kelamin" value="<?php echo $Jenis_Kelamin;?>" required>
            </div>
            <div class="form-group">
                <label>Username</label>          
                <input class="form-control" name="username" value="<?php echo $Username;?>" required >
            </div>
            <div class="form-group">
                <label>Email</label>
            ...
            <a href="<?php echo base_url();?>Dokter/lihatProfil" class="btn btn-danger"><i class="fa fa-times"></i> Cancel</a>
            </form>
</form>
