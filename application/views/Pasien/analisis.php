    ...
    <section id="search">
        <div class="container">
            ...
            <div class="panel-border" data-magellan-expedition="fixed">
                ...
                <form align="middle" action ="<?php echo base_url(); ?>Penyakit/gethasil" method="post">
            
            <!--Gejala 1-->
            <p>
            
            <td>Apa gejala pertama yang anda rasakan ? </td><td>:</td>
            <select id="gejala1" name="gejala1">
                <option value="">Please Select</option>
                <?php
                foreach ($gejala1 as $query) {
                ?>
                    <option value="<?php echo $query->gejala1; ?>">
                        <?php echo $query->gejala1; ?>
                    </option>
                <?php
                }
                ?>
            ...
            <!--<a href=" <?php site_url('Penyakit/gejala/.$query->gejala1');?> "/>-->

            <!--kota-->
            <p>
            <tr>
            <td>Apa gejala kedua yang anda rasakan ? </td><td>:</td>
            <select id="gejala2" name="gejala2">
                <option value="">Please Select</option>
                <?php

                foreach ($gejala2 as $query) {                
                ?>
                    <option value="<?php echo $query->gejala2; ?>" class="<?php echo $query->gejala1; ?>">
                        <?php echo $query->gejala2; ?>
                    </option>
                <?php
                }
                ?>
            ...
            <!--kecamatan-->
            <p>
             <td>Apa gejala ketiga yang anda rasakan ? </td><td>:</td>
            <select id="gejala3" name="gejala3">
                <option value="">Please Select</option>
                <?php
                foreach ($gejala3 as $query) {
                ?>
                    <option  class="<?php echo $query->gejala2; ?>" value="<?php echo $query->gejala3; ?>">
                        <?php echo $query->gejala3; ?>
                    </option>
                <?php
                }
                ?>
        ...
        <td height="42"> </td>
    <td> </td>
    <td><input type="submit" name="tambah" value="Analisis"></td>
  </tr>
        </form>
