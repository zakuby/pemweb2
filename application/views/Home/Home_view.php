...
<body id="page-top" class="index">
                    ...
                    <a href="#portfolioModal1" class="portfolio-link" data-toggle="modal">
                        <div class="caption">
                            <div class="caption-content">
                                <a href="<?php echo base_url(); ?>Penyakit/analisis"><h3>Analisis Penyakit</h3><i class="fa fa-search-plus fa-3x"></i>
                            </div>
                        </div>
                        <a href="<?php echo base_url(); ?>Home/analisis.php"><img src="<?php echo base_url(); ?>assets/home/img/portfolio/analisis.png" class="img-responsive" alt="">
                    </a>
                </div>
                <div class="col-sm-4 portfolio-item">
                    <a href="#portfolioModal2" class="portfolio-link" data-toggle="modal">
                        <div class="caption">
                            <div class="caption-content">
                               <a href="<?php echo base_url(); ?>Home/dokter"><h3>Lihat Daftar Dokter</h3> <i class="fa fa-search-plus fa-3x"></i></a>
                            </div>
                        </div>
                        <a href="<?php echo base_url(); ?>Home/dokter"><img src="<?php echo base_url(); ?>assets/home/img/portfolio/dokter.png" class="img-responsive" alt="">
                    </a>
                </div>
                <div class="col-sm-4 portfolio-item">
                    <a href="#portfolioModal3" class="portfolio-link" data-toggle="modal">
                        <div class="caption">
                            <div class="caption-content">
                                <a href="<?php echo base_url(); ?>Home/rumahsakit"><h3>Lihat Daftar Rumah Sakit</h3><i class="fa fa-search-plus fa-3x"></i>
                            </div>
                        </div>
                        <a href="<?php echo base_url(); ?>Home/rumahsakit"><img src="<?php echo base_url(); ?>assets/home/img/portfolio/rumah sakit.jpg" class="img-responsive" alt="">
                    </a>
                </div>
    ...
    <!-- About Section -->
    <section class="success" id="Tentang">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2>Tentang</h2>
